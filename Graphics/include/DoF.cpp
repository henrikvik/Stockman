...
namespace Graphics
{
    DoF::DoF(ID3D11Device * device):
        blur1col0(device, WIN_WIDTH, WIN_HEIGHT, DXGI_FORMAT_R16G16B16A16_FLOAT),
        blur1col1(device, WIN_WIDTH, WIN_HEIGHT, DXGI_FORMAT_R16G16B16A16_FLOAT),
        blur2Final(device, WIN_WIDTH, WIN_HEIGHT, DXGI_FORMAT_R32G32B32A32_FLOAT),
