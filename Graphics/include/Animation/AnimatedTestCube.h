...
static Skeleton testSkeleton = []() {
    ...
    rootJoint.addChild({ 1, Matrix::CreateTranslation(-1, 0, 0) });
    rootJoint.addChild({ 2, Matrix::CreateTranslation( 1, 0, 0) });
    rootJoint.addChild({ 3, Matrix::CreateTranslation( 0,-1, 0) });
    rootJoint.addChild({ 4, Matrix::CreateTranslation( 0, 1, 0) });
    rootJoint.addChild({ 5, Matrix::CreateTranslation( 0, 0,-1) });
    rootJoint.addChild({ 6, Matrix::CreateTranslation( 0, 0, 1) });
