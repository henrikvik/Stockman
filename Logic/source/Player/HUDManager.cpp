...
void HUDManager::constructGUIElements()
{
    ...
    staticElements.push_back(Sprite(Sprite::CENTER, Sprite::CENTER, 0, -200, 512.f, 128.0f, Resources::Textures::WaveComplete, FloatRect({ 0.0f, 0.0f }, { 1.0f, 1.0f }), 1.0f, false));
}
