...
void SkillManager::init(Physics* physics, ProjectileManager* projectileManager)
{
	m_allSkills =
	{
        ...
        { new SkillBulletTime(projectileManager, ProjectileData(0, 100, 1.f, 0, 0.f, BULLET_TIME_DURATION, Graphics::ModelID::SPHERE, 1, ProjectileType::ProjectileTypeBulletTimeSensor, true)) }
    };
