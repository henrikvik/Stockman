...
void SkillManager::init(Physics* physics, ProjectileManager* projectileManager)
{
	m_allSkills =
	{
        ...
        { newd SkillBulletTime(projectileManager, ProjectileData(nullptr, false, false, 0, 100, 1.f, 0, 0.f, BULLET_TIME_DURATION, Resources::Models::UnitCube, 1, ProjectileType::ProjectileTypeBulletTimeSensor, true)) }
    };
