...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        ...
        /* Secondary*/      newd Weapon(projectileManager, ProjectileData(10, 0.1f, 1, 100, 0.f, 500, Resources::Models::CrossBowProjectile, 1), Weapon::WeaponInfo{ 1, 18, 15, 10, 100, 0, 0 }),
