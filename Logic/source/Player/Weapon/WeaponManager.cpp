...
void WeaponManager::initializeWeapons()
{
	...
	m_allWeapons =
	{
		// I CHANGED THIS TO TEST ENEMIES
		{ m_projectileManager, ProjectileData(1, 1, 1, 100, 0, 3000, Graphics::ModelID::CUBE, 1), 1, 600000, 6000000, 3000, 300000, 1, 1, 0, 0, 1, 9999999, 0.00000f, 0.0000f},
