...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        ...
        /* Secondary*/      newd Weapon(projectileManager, ProjectileData(10, 1.f, 1, 100, 0.f, 1000, Resources::Models::CrossBowProjectile, 1), Weapon::WeaponInfo{ 1, 18, 15, 4, 100, 0, 0 }),
