...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        ...
        /* Secondary*/      newd WeaponMeleeParry(projectileManager, ProjectileData(0, 2.f, 1, 0, 0, 200, Graphics::ModelID::CUBE, 1, ProjectileType::ProjectileTypeMeleeParry, true, false, false), Weapon::WeaponInfo{ 5, 1, 0, 0, 50.f, 0.f, 0 }, 8.f),
