...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        // Gattling
        newd WeaponLoadout{
        /* Primary */       newd Weapon(projectileManager, ProjectileData(25, 1.f, 1, 100, 0.f, 3000, Resources::Models::Crossbowbolt , 1), Weapon::WeaponInfo{ 0, 1, 0, 0, 100, 0, 0 }),
        /* Secondary*/      newd Weapon(projectileManager, ProjectileData(25, 1.f, 1, 100, 0.f, 1000, Resources::Models::Crossbowbolt, 1), Weapon::WeaponInfo{ 1, 18, 15, 4, 100, 0, 0 }),
