...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        ...
        /* AmmoContainer */ newd AmmoContainer(AmmoContainer::AmmoInfo{ 60, 60, 30, 30, 1, 6, 1000 }),
        ...
        /* Secondary*/      newd WeaponFreezeGrenade(projectileManager, ProjectileData(0, 1, 1, 50, 5, 5000, Graphics::ModelID::CUBE, 1, ProjectileType::ProjectileTypeFreezeGrenade, true), Weapon::WeaponInfo{ 3, 1, 0, 0, 100.f, 0.f, 1 }, ProjectileData(2, 0.2f, 1, 30, 0, 200, Graphics::ModelID::CUBE, 1, ProjectileType::ProjectileTypeNormal, true), 8),
        /* AmmoContainer */ newd AmmoContainer(AmmoContainer::AmmoInfo{ 300, 200, 100, 10000000, 1, 10, 1500 }),
        ...
        // Sledge/Melee
        newd WeaponLoadout{ 
        /* Primary */       newd Weapon(projectileManager, ProjectileData(1, 1.f, 1, 0, 0, 0, Graphics::ModelID::CUBE, 1, ProjectileType::ProjectileTypeMelee, true, false, false), Weapon::WeaponInfo{ 4, 1, 0, 0, 100.f, 200.f, 0 }),
        /* Secondary*/      newd Weapon(projectileManager, ProjectileData(1, 1.f, 1, 0, 0, 0, Graphics::ModelID::CUBE, 1, ProjectileType::ProjectileTypeMelee, true, false, false), Weapon::WeaponInfo{ 5, 1, 0, 0, 100.f, 200.f, 0 }),
