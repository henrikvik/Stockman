...
void WeaponManager::initializeWeapons(ProjectileManager* projectileManager)
{
    ...
    m_weaponLoadouts =
    {
        // Gattling
        newd WeaponLoadout{
        /* Primary */       newd Weapon(projectileManager, ProjectileData(nullptr, 25, 1.f, 1, 100, 0.f, 3000, Resources::Models::Crossbowbolt , 1), Weapon::WeaponInfo{ 0, 1, 0, 0, 100, 0, 0 }),
        /* Secondary*/      newd Weapon(projectileManager, ProjectileData(nullptr, 25, 1.f, 1, 100, 0.f, 1000, Resources::Models::Crossbowbolt, 1), Weapon::WeaponInfo{ 1, 18, 15, 4, 100, 0, 0 }),
        ...
        // Ice
        newd WeaponLoadout{
        /* Primary */       newd Weapon(projectileManager, ProjectileData("Icecone", 0, 1, 1, 20, 0, 675, Resources::Models::UnitCube, 1, ProjectileType::ProjectileTypeIce, true), Weapon::WeaponInfo{ 2, 1, 17, 5, 750, 0, 1 }),
        /* Secondary*/      newd WeaponFreezeGrenade(projectileManager, ProjectileData(nullptr, 40, 1.f, 1, 100, 0, 5000, Resources::Models::Ammocrystal, 1, ProjectileType::ProjectileTypeFreezeGrenade), Weapon::WeaponInfo{ 3, 1, 0, 0, 50, 0, 0 }, ProjectileData(nullptr, 10, 0.5f, 1, 10, 5, 5000, Resources::Models::Ammocrystal, 1, ProjectileType::ProjectileTypeIceShard), 8),
        ...
        // Sledge/Melee
        newd WeaponLoadout{ 
        /* Primary */       newd Weapon(projectileManager, ProjectileData(nullptr, 35, 2.f, 1, 0, 0, 0, Resources::Models::UnitCube, 1, ProjectileType::ProjectileTypeMelee, true, false, false), Weapon::WeaponInfo{ 4, 1, 0, 0, 400, 200, 0 }),
        /* Secondary*/      newd WeaponMeleeParry(projectileManager, ProjectileData(nullptr, 0, 2.f, 1, 0, 0, 200, Resources::Models::UnitCube, 1, ProjectileType::ProjectileTypeMeleeParry, true, false, true), Weapon::WeaponInfo{ 5, 1, 0, 0, 50, 0, 0 }, 8.f),
