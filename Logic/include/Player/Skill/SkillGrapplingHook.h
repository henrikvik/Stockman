...
#define GRAPPLING_HOOK_POWER		0.00105f	// The amount of power to reach the max speed
#define GRAPPLING_HOOK_MAX_SPEED_XZ	0.06f		// The max speed in x & z
#define GRAPPLING_HOOK_MAX_SPEED_Y	65.f		// The max speed in y
