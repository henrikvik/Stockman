...
namespace Resources
{
    ...
    namespace Particles
    {
        ...
        const std::map<Files, const char *> Paths =
        {
            {BillboardParticleSimple, R"(Resources\Particles\BillboardParticleSimple.hlsl)"},
            {GeometryDefault, R"(Resources\Particles\GeometryDefault.hlsl)"},
            {GeometryFireSmoke, R"(Resources\Particles\GeometryFireSmoke.hlsl)"},
            {GoodNoise, R"(Resources\Particles\GoodNoise.png)"},
            {Mask, R"(Resources\Particles\Mask.png)"},
            {Plane, R"(Resources\Particles\Plane.dds)"},
            {Sphere, R"(Resources\Particles\Sphere.png)"},
            {SPLASH, R"(Resources\Particles\SPLASH.png)"},
            {TrailParticleSimple, R"(Resources\Particles\TrailParticleSimple.hlsl)"}
        };
    ...
    namespace Shaders
    {
        ...
        const std::map<Files, const char *> Paths =
        {
            ...
            {DepthPixelShader, R"(Resources\Shaders\DepthPixelShader.hlsl)"},
            ...
            {Fog, R"(Resources\Shaders\Fog.hlsl)"},
            {FoliageShader, R"(Resources\Shaders\FoliageShader.hlsl)"},
            ...
            {GeometryParticle, R"(Resources\Shaders\GeometryParticle.hlsl)"},
