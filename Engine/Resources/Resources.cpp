...
namespace Resources
{
    ...
    namespace Particles
    {
        Files toEnum(const char * str)
        {
            if (strcmp(str, "BillboardParticleSimple") == 0) return BillboardParticleSimple;
            if (strcmp(str, "GeometryDefault") == 0) return GeometryDefault;
            if (strcmp(str, "GeometryFireSmoke") == 0) return GeometryFireSmoke;
            if (strcmp(str, "GoodNoise") == 0) return GoodNoise;
            if (strcmp(str, "Mask") == 0) return Mask;
            if (strcmp(str, "Plane") == 0) return Plane;
            if (strcmp(str, "Sphere") == 0) return Sphere;
            if (strcmp(str, "SPLASH") == 0) return SPLASH;
            if (strcmp(str, "TrailParticleSimple") == 0) return TrailParticleSimple;
            throw "Could not find matching enum.";
        }
    }
    namespace Shaders
    {
        Files toEnum(const char * str)
        {
            ...
            if (strcmp(str, "DepthPixelShader") == 0) return DepthPixelShader;
            ...
            if (strcmp(str, "Fog") == 0) return Fog;
            if (strcmp(str, "FoliageShader") == 0) return FoliageShader;
            ...
            if (strcmp(str, "GeometryParticle") == 0) return GeometryParticle;
